...
#    newFert2name="NPK15_15_15", newFert2N_Perc=15, newFert2P2O5_Perc=15, newFert2K2O_Perc=15, newFert2CostperBag= 6000, newFert2BagWt=50,
...
PlantingWeekNr <- droplevels(Month_WkNr[Month_WkNr$monthName %in% input$plantingMonths, ])
